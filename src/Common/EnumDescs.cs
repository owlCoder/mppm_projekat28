...
namespace FTN.Common
{
    public class EnumDescs
    {
        ...
        public EnumDescs()
        {
            property2enumType.Add(ModelCode.BASICINTSCH_VAL1_MUL, typeof(UnitMultiplier));
            property2enumType.Add(ModelCode.BASICINTSCH_VAL1_UNT, typeof(UnitSymbol));
            property2enumType.Add(ModelCode.BASICINTSCH_VAL2_MUL, typeof(UnitMultiplier));
            property2enumType.Add(ModelCode.BASICINTSCH_VAL2_UNT, typeof(UnitSymbol));

            property2enumType.Add(ModelCode.REGCTRL_MODE, typeof(RegulatingControlModeKind));
            property2enumType.Add(ModelCode.REGCTRL_MONITPHASE, typeof(PhaseCode));
        }
